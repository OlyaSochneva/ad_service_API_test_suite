...
class TestCreateNotification:
    ...
    @allure.title('(401)Нельзя создать уведомление с отсут./невалидным токеном')
    ...
    @allure.title('(400)Нельзя создать уведомление, если одно из обязательных полей отсутствует')
